// @/components/theme (pdfcraft-mobile)
// md3: material.io/blog/material-3-expressive
...
export const home = (mode: ThemeType) => {
	...
	return (cache[cache_key] = StyleSheet.create({
		...
		// search bar
		// m3-expressive uses extra large shape (28dp) pill
		search_row: {
			flexDirection: 'row',
			alignItems: 'center',
		...
		menu_handle: {
			width: 40, height: 4,
			backgroundColor: Colors.dark.outlineVariant,
		...
		menu_info: {
			color: Colors.dark.onSurface, marginBottom: 16,
